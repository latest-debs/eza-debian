# lx — Latest Package Tool

`lx` repackages GitHub release binaries into `.deb` packages across Debian
...
for a downloaded asset (most GitHub releases don't publish one), `lx
